...
// 		dataType: 'refEnum',
// 		enums: [
// 			100, 101, 102, 103, 200, 201, 202, 203, 204, 205, 206, 207, 300, 301, 302, 303, 304,
// 			305, 307, 308, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413,
// 			414, 415, 416, 417, 418, 419, 420, 421, 422, 423, 424, 426, 428, 429, 431, 451, 500,
// 			501, 502, 503, 504, 505, 507, 511,
// 		],
// 	},
// 	// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
// 			data: {
// 				dataType: 'array',
// 				array: { dataType: 'refObject', ref: 'GetUsersResponseDto' },
// 			},
// 			message: { dataType: 'string' },
// 			pagination: { ref: 'PaginationDataResponseModel' },
// 			timestamp: { dataType: 'string' },
...
// 		async function UpdatePasswordUserEndpoint_patchAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 					args: argsUpdatePasswordUserEndpoint_patchAsync,
// 					request,
// 					response,
// 				});
...
// 		async function UpdateUserEndpoint_putAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 			try {
// 				validatedArgs = templateService.getValidatedArgs({
// 					args: argsUpdateUserEndpoint_putAsync,
// 					request,
// 					response,
// 				});
...
// 		async function RemoveUserEndpoint_deleteAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 			try {
// 				validatedArgs = templateService.getValidatedArgs({
// 					args: argsRemoveUserEndpoint_deleteAsync,
// 					request,
// 					response,
// 				});
...
// 		async function GetUsersEndpoint_getsAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 			try {
// 				validatedArgs = templateService.getValidatedArgs({
// 					args: argsGetUsersEndpoint_getsAsync,
// 					request,
// 					response,
// 				});
...
// 		async function GetUserByIdEndpoint_getAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 			try {
// 				validatedArgs = templateService.getValidatedArgs({
// 					args: argsGetUserByIdEndpoint_getAsync,
// 					request,
// 					response,
// 				});
...
// 		async function CreateUserEndpoint_postAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 			try {
// 				validatedArgs = templateService.getValidatedArgs({
// 					args: argsCreateUserEndpoint_postAsync,
// 					request,
// 					response,
// 				});
...
// 		async function GetOrganizationByIdEndpoint_getAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 			try {
// 				validatedArgs = templateService.getValidatedArgs({
// 					args: argsGetOrganizationByIdEndpoint_getAsync,
// 					request,
// 					response,
// 				});
...
// 		async function CreateOrganizationEndpoint_postAsync(
// 			request: ExRequest,
// 			response: ExResponse,
// 			next: any
// 		) {
...
// 			try {
// 				validatedArgs = templateService.getValidatedArgs({
// 					args: argsCreateOrganizationEndpoint_postAsync,
// 					request,
// 					response,
// 				});
