...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "DataResponse_AesResponseDto_": {
        "dataType": "refObject",
        "properties": {
            "success": {"dataType":"boolean"},
            "statusCode": {"ref":"StatusCodes"},
            "data": {"ref":"AesResponseDto"},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsCreateUserEndpoint_createUser: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"ref":"AesRequestDto"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.post('/api/v1/users',
            ...(fetchMiddlewares<RequestHandler>(CreateUserEndpoint)),
            ...(fetchMiddlewares<RequestHandler>(CreateUserEndpoint.prototype.createUser)),

            async function CreateUserEndpoint_createUser(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsCreateUserEndpoint_createUser, request, response });
