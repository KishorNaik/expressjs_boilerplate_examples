...
import { SenderReceiverRequestDto } from '@/modules/producer/apps/features/v1/sendReceiver/contract';
...
describe(`create_user_endpoint_integration_test`, () => {
	...
	/*
  Command:
  node --trace-deprecation --test --test-name-pattern='should_return_200_when_api_is_called' --require ts-node/register -r tsconfig-paths/register ./src/modules/producer/tests/integrations/features/v1/sendReceiver/index.test.ts
  */
